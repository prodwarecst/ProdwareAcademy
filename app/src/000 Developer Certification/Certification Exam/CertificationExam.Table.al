/// <summary>
/// Table Certification Exam PDA (ID 70103).
/// </summary>
table 70103 "Certification Exam PDA"
{
    Caption = 'Certification Exam';
    DataClassification = CustomerContent;
    LookupPageId = "Certification Exams PDA";
    ...
    fields
    {
        ...
        field(10; "Certification Code"; Code[20])
        {
            ...
            trigger OnValidate()
            var
                Certification: Record "Certification PDA";
            begin
                Certification.Get("Certification Code");
                Role := Certification.Role;
            end;
        }
        field(20; Role; Enum "Role PDA")
        {
            Caption = 'Role';
            Editable = false;
        }
        ...
        field(70; "Passing Score"; Decimal)
        {
            ...
            CalcFormula = lookup("Certification PDA"."Passing Score" where(Code = field("Certification Code")));
        }
        field(80; Result; Enum "Exam Result PDA")
        {
            Caption = 'Result';
            Editable = false;
        }
    ...
    trigger OnDelete()
    var
        CertificationExamResult: Record "Certif. Exam Result PDA";
    begin
    ...
    var
        ...
        CertificationAnswers: Page "Certif. Answers Select. PDA";
    begin
    ...
    begin
        ...
        Report.RunModal(Report::"Certif. Exam Result PDA", false, true, CertificationExam);
    end;
    ...
    begin
        CertificationExam.Get(EntryNo);
        CertificationExam.SetRecFilter();
        Report.RunModal(Report::"Certificate PDA", false, true, CertificationExam);
    end;
    ...
    var
        CertifExamResult: Record "Certif. Exam Result PDA";
        CertificationQuestion: Record "Certification Question PDA";
    begin
        CertificationQuestion.Reset();
