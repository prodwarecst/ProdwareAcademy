/// <summary>
/// Codeunit Data Upgrade PDA (ID 70103).
/// </summary>
codeunit 70103 "Data Upgrade PDA"
{
    #region PDA-0001-GuidedExperienceItems-19.0.2111 
    ...
    var
        UpgradeTagDefinitions: Codeunit "Upgrade Tag Def PDA";
